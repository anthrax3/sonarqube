...
public class SetRuleScopeToMainTest {
  ...
  public void updates_rows_with_null_is_build_in_column_to_false() throws SQLException {
    ...
    assertThat(countRowsWithValue(Scope.MAIN)).isEqualTo(0);

    underTest.execute();

    assertThat(countRowsWithValue(null)).isEqualTo(0);
    assertThat(countRowsWithValue(Scope.MAIN)).isEqualTo(2);
  }
  ...
  public void support_large_number_of_rows() throws SQLException {
    ...
    assertThat(countRowsWithValue(Scope.MAIN)).isZero();

    underTest.execute();

    assertThat(countRowsWithValue(Scope.MAIN)).isEqualTo(2_000);
    assertThat(countRowsWithValue(null)).isEqualTo(0);
  }
  ...
  private int countRowsWithValue(@Nullable Scope value) {
    if (value == null) {
  ...
  private void insertRow(int id, @Nullable Scope scope) {
